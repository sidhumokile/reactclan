    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-600">
          ...
          <strong>user interfaces</strong>, especially for single-page applications.
        </p>
        <p className="text-gray-600">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-2">
          <li><strong>React 15</strong> – Early stable versions</li>
          <li><strong>React 16</strong> – Introduced Fragments & Error Boundaries</li>
          <li><strong>React 16.8</strong> – Introduced <strong>Hooks</strong></li>
          <li><strong>React 17</strong> – Focused on upgrades</li>
          <li><strong>React 18</strong> – Improved performance & concurrency</li>
        </ul>
        <p className="text-gray-600">
